...
function calendarPanel() {
  ...
  return (
    ...
    new Intl.DateTimeFormat("fa-IR", { month: "long", year: "numeric" }).format(
      b,
    ) +
    '</h2><button id="prev-month">←</button></div><div class="week"><span>ش</span><span>ی</span><span>د</span><span>س</span><span>چ</span><span>پ</span><span>ج</span></div><div class="calendar">' +
    cells.join("") +
